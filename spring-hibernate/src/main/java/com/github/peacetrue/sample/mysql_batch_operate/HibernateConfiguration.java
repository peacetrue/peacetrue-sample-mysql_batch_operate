...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.github.peacetrue");
...
//        dataSource.setUrl("jdbc:h2:mem:db;DB_CLOSE_DELAY=-1");
        ...
        dataSource.setUrl("jdbc:log4jdbc:h2:mem:db;DB_CLOSE_ON_EXIT=FALSE;MODE=MySQL;DATABASE_TO_LOWER=TRUE");
